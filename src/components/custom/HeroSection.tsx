...
export function HeroSection() {
  return (
    <div className="w-full relative flex flex-col items-center mt-20 p-10 gap-10 min-h-[700px] lg:min-h-[700px]">
      {/* Background Gradient */}
      <div
        className="
          absolute
      ...
      >
        ...
        <motion.p
          initial={false}
          className="max-w-lg leading-6 tracking-wide md:text-md text-sm text-neutral-300 bg-white/10 backdrop-blur rounded-xl border border-white/20 px-4 py-3 shadow-lg"
        >
